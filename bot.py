...
OWNER = "<your_owner_username_here>"  # example: "@NR_CODEX"
API_URL = "https://no-permanent-like-api.vercel.app/like?uid={uid}&server_name={region}"
WEBHOOK_URL = "https://no-permanent-like-onrender.com/"
PORT = int(os.environ.get("PORT", 5000))
ADMIN_IDS = [7444430454]  # example: [123456789]
ALLOWED_GROUPS = {-1002870639437}  # example: {-1001234567890}
vip_users = {7444430454}
